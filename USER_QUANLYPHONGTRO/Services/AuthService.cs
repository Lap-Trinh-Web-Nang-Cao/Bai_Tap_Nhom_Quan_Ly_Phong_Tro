...
namespace USER_QUANLYPHONGTRO.Services
{
    ...
    public class AuthService
    {
        ...
        /// Gọi API /nguoidung/login để lấy JWT Token
        /// </summary>
        public async Task<LoginResponse> LoginAsync(string email, string password)
        {
            try
            {
                ...
                var apiBase = ConfigurationManager.AppSettings["ApiBaseUrl"] ?? "http://localhost:7039/api/";
                var url = $"{apiBase}nguoidung/login";
